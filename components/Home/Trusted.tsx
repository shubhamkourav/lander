    ...
    <section className="bg-white dark:bg-gray-900">
          <div className="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
              ...
              <p className="text-lg font-medium text-purple-600 dark:text-purple-500">Trusted Worldwide</p>
                <h2 className="mt-3 mb-4 text-3xl font-extrabold tracking-tight text-gray-900 md:text-3xl dark:text-white">Trusted by over 500 million users and 8,000 teams</h2>
                <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">We prioritize strict security and compliance standards in everything we do, ensuring the utmost protection for you and your customers.</p>
                  <div className="pt-6 mt-6 space-y-4 border-t border-gray-200 dark:border-gray-700">
                      <div>
                          <Link href={"#"} className='inline-flex items-center text-base font-medium text-purple-600 hover:text-purple-800 dark:text-purple-500 dark:hover:text-purple-700'>
              ...
              <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <p className="font-light text-gray-500 dark:text-gray-400">For Lander, with zero maintenance downtime</p>
                </div>
                <div>
                    ...
                    <h3 className="mb-2 text-2xl font-bold dark:text-white">500M+ Users</h3>
                    <p className="font-light text-gray-500 dark:text-gray-400">Trusted by over 500 million users around the world</p>
                </div>
                <div>
                    ...
                    <p className="font-light text-gray-500 dark:text-gray-400">Have used Lander to create functional websites</p>
                </div>
                <div>
                    ...
                    <h3 className="mb-2 text-2xl font-bold dark:text-white">3+ Million</h3>
