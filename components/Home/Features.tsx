        ...
        <section className="bg-gray-50 dark:bg-gray-800">
            <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
                <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                    <div className="text-gray-500 sm:text-lg sm:text-gray-400">
                        ...
                        <ul role='listbox' className="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                ...
                <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                    <img src="/images/feature-2.png" alt="dashboard feature image" className="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" />
                    <div className="text-gray-500 sm:text-lg lg:text-gray-400">
